...
function createComponent() {
	...
	const getChronoSpy = {
		...
		getStatusForSession: jasmine
			.createSpy("getStatusForSession")
			.and.callFake((_id: string) => sessionScopedStatusSignal),
		getElapsedForSession: jasmine
			.createSpy("getElapsedForSession")
			.and.callFake((_id: string) => sessionScopedElapsedSignal),
	};
...
function createComponentWithChronoStatus(chronoStatus: ChronoStatus, sessionStatus: "active" | "completed" = "active") {
