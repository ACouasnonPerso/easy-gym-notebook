...
async function setup(initialUrl: string) {
  await TestBed.configureTestingModule({
    ...
    providers: [
      ...
      { provide: SESSION_REPOSITORY, useValue: { getAll: () => Promise.resolve([]), getById: () => Promise.resolve(null), save: () => Promise.resolve(), delete: () => Promise.resolve() } },
      { provide: EXERCISE_REPOSITORY, useValue: { getAll: () => Promise.resolve([]), getBySessionId: () => Promise.resolve([]), save: () => Promise.resolve(), delete: () => Promise.resolve() } },
    ],
  }).compileComponents();
  setupI18n();
